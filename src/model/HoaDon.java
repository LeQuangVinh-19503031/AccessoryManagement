...
public class HoaDon {
	...
	public HoaDon(String maHD, String maKH, String maNV, Date date, Date date2, String diaChiGiaoHang) {
		this.maHD = maHD;
		this.maKH = maKH;
		this.maNV = maNV;
	...
	public HoaDon returnHD() {
		return new HoaDon("DH01", "KH01", "NV01", new Date("04/21/2023"), new Date("04/24/2023"), "DiaChi");
	}
